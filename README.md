...
It now also checks Sprint 2 extraction-layer consistency, including exempt-style classification flags, lineage link sanity, and placeholder payment-history mismatches.
